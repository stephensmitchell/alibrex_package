...
| `examples/pdm/` | PDM (Product Data Management) walk-through - 13 progressive scripts: connect - safes - property defs / classes / templates - projects / libraries / folder tree - file properties + version history - locked-file scan |
