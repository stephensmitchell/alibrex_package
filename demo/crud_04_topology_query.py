...
def main() -> int:
    ...
    # Body COM proxies in AlibreX 29 can go stale between property reads.
    # Re-fetch the body for each query to avoid "Object no longer exists in
    # server" on chained access like body.Faces / body.Edges / body.Vertices.
    ...
    try:
        ...
        # Euler for a closed convex polyhedron: V - E + F = 2 -> V = 2 + E - F
        verts = 2 + edges - faces
