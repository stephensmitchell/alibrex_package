...
def main() -> int:
    ...
    sk.BeginChange()
    try:
        # Lines pre-trimmed back from the corner so the arc fits in the
    ...
    sk.BeginChange()
    try:
        # Pin the horizontal line's start at the origin; make it horizontal.
        ...
        # Make the vertical line vertical.
        add([vert],  ADSketchConstraintType.AD_CONSTRAINT_VERTICAL)
        # Stitch the arc into the corner.
