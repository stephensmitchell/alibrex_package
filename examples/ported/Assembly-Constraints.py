...
def main() -> None:
    ...
    # Mate / Align constraints would require IADTargetProxy instances
    # referring to the XY/YZ planes of each occurrence. Pseudocode:
    #   target1 = build_target_proxy(occ1, occ1.DesignSession.DesignPlanes.Item(0))
    #   target2 = build_target_proxy(occ2, occ2.DesignSession.DesignPlanes.Item(0))
