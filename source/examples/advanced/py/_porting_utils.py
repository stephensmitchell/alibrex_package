...
These helpers stay local to the advanced/ folder rather than the alibrex
package: porting glue, not core API.
"""
...
def sketch_rectangle(part, plane, name: str, x1: float, y1: float, x2: float, y2: float):
    ...
    Uses four AddLine calls; AlibreX 29's ``AddRectangle`` can be
    unreliable inside auto-bracketed transactions. The proxy
    auto-brackets BeginChange/EndChange.
    """
